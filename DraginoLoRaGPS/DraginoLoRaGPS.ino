...
/*
  ...
  network initially.
*/
static const u1_t PROGMEM APPSKEY[16] = { 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ, 0xZZ };

/*
  LoRaWAN end-device address (DevAddr)
  See http://thethingsnetwork.org/wiki/AddressSpace
*/
static const u4_t DEVADDR = 0xZZZZZZZZ;
